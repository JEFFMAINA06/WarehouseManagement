...
public class Login extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        String userpassword = new String(passwordTxt.getPassword()); // PasswordField for security

        // Call the method to verify credentials
        boolean isValidUser = UserDAO.checkLoginCredentials(useremail, userpassword);
